...
ADMIN_INTERVIEW_MORNING_SENT = "📨 Morning reminder sent to {name} (@{tg}) for interview at {slot}. Waiting for confirmation..."
ADMIN_INTERVIEW_RETRY_SENT = "⚠️ {name} (@{tg}) hasn't responded for 2h. Retry reminder sent for interview at {slot}."
